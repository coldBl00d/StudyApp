...
public class Subject {
    ...
    public SQLiteDatabase settingDatabase() {
        String[][] columnNames = {
                {"_id","name","category","colorpref"},
                {"_id","sid","avg_hrs","avg_min","today_hrs","today_min","pastmonth_hrs","pastmonth_min"}//add more tables as we procceed

        };
        String[][] columnTypes = {
                {"INTEGER","VARCHAR(200)","VARCHAR(200)","INTEGER"},
                {"INTEGER","INTEGER","INTEGER","INTEGER","INTEGER","INTEGER","INTEGER","INTEGER"}

        };
        String[] tableNames = {"subjects","subtimes"};
        int[] columnNos = {4,8};
    ...
    public class Asyncinsert extends AsyncTask<Void, String, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            Log.d("subject", "second value " + values[5] + " " + values[5] / 100);
            ...
            Log.d("subject", "subject getting inserted " + tdatabaseCreater.insert(db, contentValues, tableNames[0]));
